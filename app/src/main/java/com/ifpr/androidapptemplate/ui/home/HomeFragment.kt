            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (userSnapshot in snapshot.children) {
                    for (itemSnapshot in userSnapshot.children) {
                        ...
                        val imageView = itemView.findViewById<android.widget.ImageView>(R.id.item_image)
                        val nomeView = itemView.findViewById<android.widget.TextView>(R.id.item_nome)
                        val especieView = itemView.findViewById<android.widget.TextView>(R.id.item_especie)
                        val dataView = itemView.findViewById<android.widget.TextView>(R.id.item_data)
                        val descView = itemView.findViewById<android.widget.TextView>(R.id.item_desc)
                        val enderecoView = itemView.findViewById<android.widget.TextView>(R.id.item_endereco)
